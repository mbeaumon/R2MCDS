...
data(quebec)
d <- mcds.filter(quebec, transect.id = "WatchID", distance.field = "Distance", 
...
### Import and filter data
data(quebec)
d <- mcds.filter(quebec, transect.id = "WatchID", distance.field = "Distance", distance.labels = c("A", "B", "C", "D"), 
