...
distance.wrap will not return an output for any model which had a status above 2.A detialed description of each error message can be found in the Distance user guide (pages 333-344).  
...
If the user is interested in keeping only the best model in the distanceList the function keep.best.model will keep the model with the lowest AICc value. If more than one model have the best AIC score the keep.best.model function will select one model randomly.
...
Once again it is possible to select the best model via the keep.best.model function.
