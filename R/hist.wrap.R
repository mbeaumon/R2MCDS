...
#'hist.wrap(alcidae, Count="Count", Dist.class="Distance", Keep.class=c("A", "B", "C", "D"), Breaks=c(0,50,100,200,300))
#'#END


hist.wrap <-
  function(Dataset, Count, Dist.class, Keep.class, Breaks){
